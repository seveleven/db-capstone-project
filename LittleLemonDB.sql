...
CREATE TABLE `bookings` (
  ...
  CONSTRAINT `Bookings_CustomerID_FK` FOREIGN KEY (`CustomerID`) REFERENCES `customer` (`CustomerID`)
...
CREATE TABLE `menu` (
  ...
  CONSTRAINT `Menu_MenuItemsID_FK` FOREIGN KEY (`MenuItemsID`) REFERENCES `menuitems` (`MenuItemsID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `menuitems` (
  `MenuItemsID` int NOT NULL,
  `MainCourseName` varchar(45) NOT NULL,
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `Orders_DeliveryID_FK` FOREIGN KEY (`DeliveryID`) REFERENCES `deliverystatus` (`DeliveryID`),
  CONSTRAINT `Orders_MenuID_FK` FOREIGN KEY (`MenuID`) REFERENCES `menu` (`MenuID`),
  CONSTRAINT `Orders_StaffID_FK` FOREIGN KEY (`StaffID`) REFERENCES `staff` (`StaffID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-05-08  0:37:39
